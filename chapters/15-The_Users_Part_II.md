...
不久之后，Nigel Martin 是玛丽女王学院（QMC）的一名学生，当城市学院的 Sunil Das 获得了 Western Electric 许可后，就不必再等新泽西去处理向英国运送软件的问题了：Sunil 从 Nigel 那里拿到了 V5+ 版本。
...
>
>我们与 DEC 维护人员也有冲突，因为他们要求运行 RSX 或 VMS，否则无法修复我们的硬件问题。但由于 Unix 下的报错信息更清晰，我们最终说服了他们。可是，如何在有缺陷的计算机系统上安装 VMS 或 RSX 呢？
...
Stettner 向澳大利亚发送 news，其实并不像听起来那么奇怪。1974 年夏天，当新南威尔士大学（UNSW）准备接收一台 PDP-11/40 时，John Lions 在《CACM》上读到了那篇文章，随后学校在年底前就与西部电气商定了许可证。以下是 Lions 的叙述：
...
>
>我的工作职责之一（也就是职责）是教 SRA“Unix 的方法”。我觉得如果“Unix 的方法”有社会层面，我还得试着解释什么是“黑客”和“nerd”（书呆子）。因为语言和文化障碍（我的日语从来没学好），花了很久他们才真正理解。黑客这个概念对他们来说非常有吸引力。至于 nerd，他们理解得比较困难，我觉得他们没能像我那样对 nerd 产生负面反应。大概是因为他们认为 nerd 的执着也没什么坏处。
