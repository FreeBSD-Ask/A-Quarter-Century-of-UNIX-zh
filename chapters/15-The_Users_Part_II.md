...
> 新南威尔士大学用一台运行 KRONOS 的 CDC Cyber 72-26 计算机替换了之前的 1965-vintage IBM 360/50。新的网络使可以驱动100台打字机式(300波特率)交互终端和12台PDP-11/40计算机。当7台最小配置(16Kb内存)的PDP-11/40s买来后，5个系统安装了128Kb核心内存，每台机器都配有一个DJ11终端复用器和3个RK05磁盘位。
