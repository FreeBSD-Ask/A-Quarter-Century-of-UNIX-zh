...
同期的《《软件工具》Communications》列出了近三十种实现了这些工具的架构，以及实现者的姓名和地址。制造商按字母顺序从 Burroughs 到 Zilog 不等；机器规模则从 Z80/8080（64k 字节程序内存）到 IBM 370 和 DEC 20。地理位置上，实现者遍布全球：从日本川崎，经美国和加拿大，到英国和荷兰埃因霍温。
